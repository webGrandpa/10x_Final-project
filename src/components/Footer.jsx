...
const Footer = () => {
    ...
    // ];
    const ServiceLinks = [
        { id: 1, title: 'ბუღალტრული მომსახურება', href: '/accountingservices' },
        { id: 2, title: 'იურიდიული მომსახურება', href: '/lawservices' },
        { id: 3, title: 'ფინანსური კონსულტაცია', href: '/consultation' },
        { id: 4, title: 'სხვა სერვისები', href: '/another-services' },
    ];
    const ContactLinks = [
