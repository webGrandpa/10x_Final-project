...
const SectionHeaders = ({ header, paragraph, bgcolor, hasDivider = true, textCenter = "center", padding = "py-20", rounded = 'none', children, size = "text-3xl", pSize = "lg", gap = "4" }) => {
  return (
    <div className={`text-${textCenter} ${padding} 
    flex flex-col gap-${gap} ${bgcolor} rounded-${rounded} `}>
