...
import { educationData } from './data/homePage/educationData.js';
    ...
    <div className='text-center bg-white flex flex-col justify-between gap-6 px-6 md:px-10 lg:px-20 pb-10'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between gap-10'>
          <img
            ...
            src={educationData.image} alt="Students" />
                  ...
                  >
                    <div className='flex flex-row justify-start gap-4 items-center w-full'>
                        {course.figures.map(figure => (
                           <Figure key={figure.caption} image={figure.image} caption={figure.caption} direction='row' />
                        ))}
                    </div>
                 </SectionHeaders>
              ))}
